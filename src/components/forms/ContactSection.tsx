...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="border-b border-slate-100 bg-white">
              ...
              <form className="space-y-4" onSubmit={onSubmit}>
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none transition focus:ring-4 focus:ring-emerald-600/15"
                  />
                </div>
                <div>
                  <label className="text-xs font-semibold text-slate-700">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-1 w-full resize-y rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:ring-4 focus:ring-emerald-600/15"
                  />
                </div>
                <button
                  type="submit"
