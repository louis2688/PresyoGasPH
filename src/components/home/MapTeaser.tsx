  ...
  return (
    <section className="border-b border-slate-100 bg-slate-50/60">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 md:grid-cols-2 md:items-center">
        <div>
          ...
          <ul className="mt-8 space-y-4 text-sm text-slate-700">
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-slate-900">Pin colors</strong> — best
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-slate-900">Filters</strong> — fuel
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-slate-900">No API keys</strong> in this
        ...
        <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-100 to-emerald-50 shadow-inner">
          ...
          <div className="absolute left-8 top-10 size-4 rounded-full bg-emerald-500 shadow-lg ring-4 ring-white" />
          <div className="absolute right-16 top-24 size-3 rounded-full bg-amber-400 shadow ring-4 ring-white" />
          <div className="absolute bottom-16 left-1/3 size-3 rounded-full bg-rose-500 shadow ring-4 ring-white" />
          <div className="absolute bottom-10 right-10 size-4 rounded-full bg-emerald-600 shadow-lg ring-4 ring-white" />
          <p className="absolute bottom-4 left-4 right-4 rounded-2xl bg-white/90 p-3 text-xs text-slate-600 shadow-sm ring-1 ring-slate-200/80 backdrop-blur">
