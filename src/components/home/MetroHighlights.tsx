  ...
  return (
    <section className="border-b border-slate-100 bg-white dark:border-slate-800 dark:bg-slate-950">
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <p className="mt-2 text-slate-600 dark:text-slate-300">As of {snapshot.updatedLabel}</p>

        <div className="mt-8 grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-6 shadow-sm dark:border-emerald-900 dark:from-emerald-950/60 dark:to-slate-900">
          ...
          <div className="rounded-2xl border border-sky-100 bg-gradient-to-br from-sky-50 to-white p-6 shadow-sm dark:border-sky-900 dark:from-sky-950/60 dark:to-slate-900">
